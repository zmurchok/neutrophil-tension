...
bettercolors
uiopen('/Users/zmurchc/Google Drive/Research/2020/neutrophil-tension/revisions/SILPAFig/SILPAFig.fig',1)
...
ylabel({'$R^\ell$'},'Interpreter','latex','FontWeight','normal','FontSize',fontsize,'FontName','Times')
