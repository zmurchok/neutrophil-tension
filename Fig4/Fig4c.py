...
for i in range(len(d1s)):
    ...
    plt.tight_layout()
    plt.savefig('4c_fixed_d1={}.tiff'.format(d1),dpi=1200)
    ...
    ax.grid()
    plt.tight_layout()
    plt.savefig('4c_fixed_d1={}_bd_plane.tiff'.format(d1),dpi=1200)

    fig = plt.subplots(1,figsize=(3,3))
    plt.plot(t,l)
    plt.tight_layout()
    plt.savefig('4c_fixed_d1={}_length.tiff'.format(d1),dpi=1200)
    # plt.show()
...
if movieon == 1:
    ...
    ani.save("Movie_4c.mp4",fps=30,dpi=300)
